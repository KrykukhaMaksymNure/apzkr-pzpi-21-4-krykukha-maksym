...
export class DatabaseService {
    ...
    async exportToExcel(): Promise<ExcelJS.Buffer> {
        ...
        const watcherWorksheet = workbook.addWorksheet('watcher');
        watcherWorksheet.columns=[
          { header: 'id', key: 'id', width: 10 },
          { header: 'createdAt', key: 'createdAt', width: 10 },
          { header: 'reason', key: 'reason', width: 10 },
          { header: 'accidentId', key: 'accidentId', width: 10 },
        ...
        watcherWorksheet.addRows(alerts);

        const carWorksheet = workbook.addWorksheet('car');
        carWorksheet.columns=[
          { header: 'id', key: 'id', width: 10 },
          { header: 'createdAt', key: 'createdAt', width: 10 },
          { header: 'reason', key: 'reason', width: 10 },
          { header: 'accidentId', key: 'accidentId', width: 10 },
        ...
        carWorksheet.addRows(alerts);
        const heartbeatWorksheet = workbook.addWorksheet('heartbeat');
        const accidentWorksheet = workbook.addWorksheet('accident');
